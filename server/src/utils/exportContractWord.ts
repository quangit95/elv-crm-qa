...
export async function generateContractWord(contract: any, company: any, res: Response) {
  ...
  res.setHeader('Content-Disposition', `attachment; filename=Contract-${contract.code}.docx`);
  res.send(buffer);
}
